...
const RestaurantList = ({ 
  ...
  return (
    <div className="border-t border-gray-200 h-full overflow-x-hidden flex flex-col">
      <div className="grid grid-cols-[30%_50%_auto] p-2 font-semibold border-b border-gray-600">
        <div>City</div>
      ...
      <div className="flex-1 overflow-y-scroll scrollbar-thumb-gray-300 scrollbar-track-gray-100 scrollbar-thin">
        {[...restaurants]
          ...
          .map(restaurant => (
          <div key={restaurant.id} className="grid grid-cols-[30%_50%_auto] p-2 border-b border-gray-100 hover:bg-gray-50">
